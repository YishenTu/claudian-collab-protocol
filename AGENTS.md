...
- Do not publish a protocol release when only Claudian or Cloud Server implementation changed. When a compatible protocol correction does require publication, use the next `3.2.x` version unless the user explicitly approves a different release line.
