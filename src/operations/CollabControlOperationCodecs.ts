...
export const COLLAB_CONTROL_OPERATION_CODECS = Object.freeze({
  ...
  registerCloudToLanPreparation: codec('registerCloudToLanPreparation'),
  listCloudToLanPreparations: codec('listCloudToLanPreparations'),
  withdrawCloudToLanPreparation: codec('withdrawCloudToLanPreparation'),
  getCloudToLanPreparationApproval: codec('getCloudToLanPreparationApproval'),
  getProjectAuthoritySuccessor: codec('getProjectAuthoritySuccessor'),
