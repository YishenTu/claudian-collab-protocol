...
export const COLLAB_CLOUD_BINDING_VERSION = 10 as const;
...
export function collabCloudProjectOperationRoute(
  ...
  return route('POST', `/v10/projects/${projectId}/operations/${operation}`, {
...
export function collabCloudProjectEventsRoute(
  ...
  return route('GET', `/v10/projects/${projectId}/events?afterSequence=${afterSequence}`, {
    afterSequence,
    kind: 'project-events',
    projectId,
  });
...
export function collabCloudGitRoute(
  ...
  if (routeKind === 'info-refs') {
    ...
    return route(
      'GET',
      `/v10/projects/${projectId}/repository.git/info/refs?service=${service}`,
      { kind: 'git-info-refs', projectId, service },
    );
  }
  if (service !== undefined) invalidRoute();
  return route('POST', `/v10/projects/${projectId}/repository.git/${routeKind}`, {
    kind: routeKind,
    projectId,
  });
}
...
export function collabCloudAuthorityTransferArtifactRoute(
  ...
  return route(
    ...
    `/v10/projects/${projectId}/authority-transfers/${transferId}/checkpoint/${artifact}`,
    {
      artifact,
      direction,
...
export function collabCloudProjectCheckpointExportArtifactRoute(
  ...
  return route(
    'GET',
    `/v10/projects/${projectId}/checkpoint-exports/${exportId}/checkpoint/${artifact}`,
    {
      artifact,
      exportId,
...
export function collabCloudProjectCheckpointExportRoute(
  ...
  return route(
    ...
    `/v10/projects/${projectId}/checkpoint-exports/${exportId}`,
...
export function collabDevelopmentBootstrapRoute(
  ...
  const base = '/v10/development/bootstrap/attempts';
